...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class MiscTab : BoxContainer
    {
        ...
        private void OnHudThemeChanged(UIKOptionButton.ItemSelectedEventArgs args)
        {
        ...
        private void UpdateApplyButton()
        {
            ...
            var isOfferModeIndicatorsSame = ShowOfferModeIndicatorsCheckBox.Pressed ==
                _cfg.GetCVar(CCVars.OfferModeIndicatorsPointShow);
            ...
            var isColorblindFriendly = ColorblindFriendlyCheckBox.Pressed ==
                _cfg.GetCVar(CCVars.AccessibilityColorblindFriendly);
            var isReducedMotionSame = ReducedMotionCheckBox.Pressed == _cfg.GetCVar(CCVars.ReducedMotion);
            var isScreenShakeIntensitySame = Math.Abs(
                ScreenShakeIntensitySlider.Value / 100f - _cfg.GetCVar(CCVars.ScreenShakeIntensity)) < 0.01f;
