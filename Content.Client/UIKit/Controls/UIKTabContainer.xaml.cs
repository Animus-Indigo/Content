...
public sealed partial class UIKTabContainer : BoxContainer
{
    private readonly Dictionary<Control, UIKButton> _tabs     = new();
    private readonly List<Control>                    _controls = new();
    private readonly ButtonGroup                      _tabGroup = new(false);

    /// All children within the <see cref="UserInterface.Controls.UIKTabContainer.ContentContainer"/>
    public OrderedChildCollection Contents => ContentContainer.Children;

    /// All children within the <see cref="UserInterface.Controls.UIKTabContainer.ContentContainer"/> that are visible
    public List<Control> VisibleContents => Contents.Where(c => c == CurrentControl).ToList();

    /// All children within the <see cref="UserInterface.Controls.UIKTabContainer.TabContainer"/>
    public OrderedChildCollection Tabs => TabContainer.Children;

    /// All children within the <see cref="UserInterface.Controls.UIKTabContainer.TabContainer"/> that are visible
    ...
    /// <inheritdoc cref="UIKTabContainer"/>
    public UIKTabContainer()
    {
    ...
    public void UpdateTabMerging()
    {
        ...
        switch (visibleTabs.Count)
        {
            ...
            case 1:
            {
                var button = (UIKButton) visibleTabs[0];
        ...
        {
            var button = (UIKButton) visibleTabs[i];
